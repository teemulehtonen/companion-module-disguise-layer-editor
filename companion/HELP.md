...
Viewer size: SMALL 100%, MEDIUM 105%, LARGE 110%, saved per browser. Track heading shows FPS, duration and TC/BEAT. IN: appears only when a transport timecode source is configured; hover for source status.
