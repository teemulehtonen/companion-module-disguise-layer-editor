...
- Designer 32.4.17 also logged "Access to object of type 'Widget' is not allowed" in TrackWidget.refresh during native layer duplication. Data readback succeeded, but native GUI refresh was not error-free. Investigation of this and the thumbnail fault is deferred; neither is considered fixed.
