...
**Downloads (0.2.0-beta.5):** [Companion module](../../releases/download/v0.2.0-beta.5/disguise-layer-control-0.2.0-beta.5.tgz) · [Stream Deck XL page](../../releases/download/v0.2.0-beta.5/D3-Stream-Deck-XL.companionconfig) · [Companion page](../../releases/download/v0.2.0-beta.5/D3-Stream-Deck-Plus.companionconfig)
