...
function browserMain() {
  ...
  function draw() {
    ...
    for (const guide of state.alignmentGuides || []) {
      ...
      const line = el('i', 'alignment-guide' + (guide.subtle ? ' subtle' : ''))
